...
public class SetPasswordPage extends javax.swing.JFrame {
    ...
    ResultSet res;
    int id;
    public SetPasswordPage(int pass) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(pass2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 500, 349, 42));
        jPanel1.add(pass1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 240, 349, 42));
        ...
        confirm.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-login-rounded-24.png"))); // NOI18N
        ...
        jPanel1.add(confirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 710, 130, 53));
        ...
        jPanel1.add(exit1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 710, 117, 53));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pina-messina-iIDiRMITYik-unsplash.jpg"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 800));
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
           ...
           if(password1.equals(password2))
        {
            ...
            dispose();
               ...
               JOptionPane.showMessageDialog(null, "New two passwords are not matching !");
           }
        } catch(Exception ex)
        {
